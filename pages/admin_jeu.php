...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Administration des jeux</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                        ...
                                        if($num>0){
                                                while ($row = $stmtJeux->fetch(PDO::FETCH_ASSOC)) {
                                                    ...
                                                    echo "<tr>";
                                                        ...
                                                        echo "<td class='text-center' ><a href='admin_jeu.php?id={$jeu_id}' class='btn btn-primary btn-xs' title='Modification'>";
