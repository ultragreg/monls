...
function getPositionChiffre($i)
{
  ...
  if ($i==7)      return "8 ème";
  if ($i==8)      return "9 ème";
  if ($i==9)      return "10 ème";
  if ($i==10)      return "11 ème";
  if ($i==11)      return "12 ème";
  if ($i==12)      return "13 ème";
  if ($i==13)      return "14 ème";
  if ($i==14)      return "15 ème";
  if ($i==15)      return "16 ème";
  if ($i==16)      return "17 ème";
  if ($i==17)      return "18 ème";
  if ($i==18)      return "19 ème";
  if ($i==19)      return "20 ème";
  if ($i==20)      return "21 ème";
  if ($i==21)      return "22 ème";
  if ($i==22)      return "23 ème";
  if ($i==23)      return "24 ème";
  if ($i==24)      return "25 ème";
  if ($i==25)      return "26 ème";
  if ($i==26)      return "27 ème";
  if ($i==27)      return "28 ème";
  if ($i==28)      return "29 ème";
  if ($i==29)      return "30 ème";
  return "...";
}
...
function getMoyenneClassement($idj, $listeClassement)
{
  for($i=0;$i<sizeof($listeClassement);$i++) {
      $c=$listeClassement[$i];
      if ($idj == $c["joueur_id"]) {
