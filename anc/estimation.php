			...
			<div id="conteneur">	
				...
				<div id="contenu">
					...
					if ($db_link)
					{
						...
						//affichage des stats quoi qu'il arrive
						$stat='O';
						...
						if ($jeu)
						{
							...
							if ($pronostic && $stat=='O') {
								echo "<h3>Estimation des gains de la grille jouée de <b>".$nom."</b></h3>";
								echo "<table><tr><td colspan=2 align=center><FONT COLOR='red'><b>Voici une estimation des gains potentiels si le jeu joué s'avère juste.</b></font></td></tr>";
							...
							?>
									<table class="jeu">
										...
										if ($pronostic && $stat == 'O') {
											...
											echo "</td><td colspan=3 align=center><br><font size=4 >Indice de gain : <font color=red>" . number_format($indice,2) . "</font>/10</font><br><br></td></tr>";
										}
										if ($stat == 'O') {
										...
										if ($stat == 'O') {
										?>
									<tr><td colspan=9 align=right>Répartition 1N2 représentatif des joueurs du Loto Foot FDJ</td></tr>
								...
								if ($bloque==1)
								{
									echo "<tr><td colspan=9><p class=\"jeubloque\">Pronostics vérouillés.</p></td></tr></table>";
								}
								else {
								?>
