...
<?php
         ...
         if (sizeof($listeGains)>0)
         {
             ...
             for($i=0;$i<sizeof($listeGains);$i++)
             {
                ...
                echo "<td width=\"150\"><b>";
                if ($i==0)      echo "Premier";
                if ($i==1)      echo "Deuxième";
                if ($i==2)      echo "Troisième";
                if ($i==3)      echo "Quatrième";
                if ($i==4)      echo "Cinquième";
                if ($i==5)      echo "Sixième";
                if ($i==6)      echo "Septième";
                if ($i==7)      echo "Huitième";
                if ($i==8)      echo "Neuvième";
                if ($i==9)      echo "Dixième";
                if ($i==10)      echo "Onzième";
                if ($i==11)      echo "Douzième";
                if ($i==12)      echo "Treizième";
                if ($i==13)      echo "Quatorzième";
                if ($i==14)      echo "Quinzième";
                if ($i==15)      echo "Seizième";
                if ($i==16)      echo "Dix-Septième";
                if ($i==17)      echo "Dix-Huitième";
                if ($i==18)      echo "Dix-neuvième";
                if ($i==19)      echo "Vingtième";
                if ($i==20)      echo "Vingt-et-unième";
                echo "</b></td>\n";   
...
*/
       ...
       */
        ...
        echo "<div id=\"my_chart1\"> </div>"; 
         ...
         echo "<p>Ce graphe propose une évolution de la moyenne par joueur.</p>\n";
